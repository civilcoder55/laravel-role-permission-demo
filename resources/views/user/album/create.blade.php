...
<div class="container-fluid">
    <h1 class="dash-title">Create New Album</h1>
    @if (session('status'))
    <div class="row">
        <div class="col mt-3">
    ...
    <div class="row">
        <div class="col-xl">
            <div class="card easion-card">
                ...
                <div class="card-body ">
                    <form method="POST" action="{{ route('user.albums.store') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <div class="preview">
                                <img height="500px" width="500px" hidden id="preview" class="img-thumbnail">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" id="private" name='private' {{ old('private') ? checked : ''}}>
